...
import com.mingj.team.inventory.ContainerTransfer;
import com.mingj.team.network.MessageGui;
import com.mingj.team.network.PacketHandler;
...
public class GuiTeamEditor extends GuiScreen {
    ...
    public static class GuiTransfer extends GuiContainer {
        ...
        private static final ResourceLocation TEXTURE = new ResourceLocation(TeamMod.MODID,"textures/gui/transfer.png");
